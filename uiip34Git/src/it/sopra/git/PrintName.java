...
public class PrintName {
	...
	LeoneG.calcolaeta(dataNascita);
		...
		System.out.println(myNameIs("Natalia", "Albanese") + " "+ Albanese.calcolaEta(new GregorianCalendar(1995, 12,25) ) + " anni");
		...
		System.out.println(myNameIs("Andrea", "Franza")+", "+Franza.calcolaEta(1991, 7, 23)+" anni");
