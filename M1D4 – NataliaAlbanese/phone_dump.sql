...
insert into Contatto(id, nome, cognome, numtelefono) values 
	(1, 'Antonio', 'Belli', '8796447738'),
    (2, 'Davide', 'Fedestro', '7843025722');
    
insert into rubrica(id, idcontatto, modellotel, idsmartphone) values
	('0001', 1, 'Galaxy S4 mini', 6),
	('0002', 2, 'Blackberry Z30', 14);
